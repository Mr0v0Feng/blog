...
<!-- 小熊猫 -->
<div style="width: 130px;opacity: 0.8;margin-bottom: -4px;padding-bottom:0;position: fixed;bottom: 0;left: 0.5rem;z-index: 1;text-align: center;">
  <img src="/img/panda-waving.png" class="panda no-zoom" >
  <img src="/img/grass.png" class="panda no-zoom" style="margin-left: 12px;transform:translateY(-12px);">
</div>
