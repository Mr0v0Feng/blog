...
import CWeather from '@theme/components/CWeather'
...
export default {
  components: { Home, Navbar, Page, CategoriesPage, TagsPage, ArchivesPage, Sidebar, Footer, Buttons, BodyBgImg, CWeather },
